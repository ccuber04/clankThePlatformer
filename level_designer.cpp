...
LevelDesigner::LevelDesigner(const std::string &level_name, int width, int height)
    ...
    display_rect{0.0f, 0.0f, graphics.width*(3.0f/5.0f), static_cast<float>(graphics.height)},
    tiles_rect{graphics.width*(3.0f/5.0f), 0.0f, graphics.width*(2.0f/5.0f), static_cast<float>(graphics.height)}{
    update_title();
