...
enum class StateType {Standing, InAir, Running, DoubleJump, Crouching, AttackAll, Patrolling};
enum class Transition {Jump, Stop, Move, Crouch, AttackAll, Patrolling};
